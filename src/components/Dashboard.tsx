      ...
      <div className="main-container">
        ...
        <div className="site-header">
          <span className="site-title">
            Layer1.wtf || Built by <a href="https://l1beat.io" className="link" target="_blank" rel="noopener noreferrer">L1Beat</a>
          </span>
        </div>
        ...
        <div className="tabs-section">
          ...
          <div className="tab inactive" onClick={handleIcmClick}>ICM</div>
        </div>

        {/* Totals */}
        <div className="totals-section">
          <div className="totals-header">Totals</div>
          <MetricsPanel metrics={metrics} loading={loading} chainData={sortedChainData} />
        </div>
